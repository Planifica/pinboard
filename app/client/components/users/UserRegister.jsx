C.UserRegister = React.createClass({
    ...
    onSubmit(event) {
      ...
      let fullname = $(event.target).find('[name=fullname]').val()
        ...
        <div className="user-login">
            <div className="user-login-container">
                ...
                <form onSubmit={this.onSubmit} className="u-full-width row">
                    ...
                    classExtendInput="u-full-width"/>
                    <C.FormInput hasError={!!this.state.errors.password} name="Password" type="password"
                    label="Password" classExtendInput="u-full-width"/>
